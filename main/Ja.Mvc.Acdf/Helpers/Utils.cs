...
namespace JA.Helpers
{
    public class Utils
    {
        ...
        public static void MyThumbUtil(Ja.Mvc.Acdf.Models.PhotoViewModel photo, System.Web.Mvc.Controller controller)
        {
            try
            {
        ...
        /// <param name="controller">Controller calling</param>
        /// <returns>Path where photo is stored with it's calculated filename, or default photo "BlankPhoto.jpg" or null on error</returns>
        //public static string[] SaveAcdfPhotoFileToDisk(System.Web.Helpers.WebImage webImage, Ja.Mvc.Acdf.Controllers.PhotoController controller, string categoryName, string subCategoryName)
        //{
